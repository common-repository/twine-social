<?php
/*
 * Plugin Name: TwineSocial
 * Plugin URI: https://twinesocial.com
 * Description: Display your social media content with the TwineSocial Wordpress plugin by using hashtags and user content, in a beautiful and interactive view. To get started activate TwineSocial plugin and then go to TwineSocial setting page to setup your account.
 * Version: 3.0.1
 * Author: Nitin Tokas, Aaron Fessler
...
if (!defined('TWINE_PUBLIC_URL')) {
	define('TWINE_PUBLIC_URL',  '//twinesocial.com');
}
...
add_filter( 'plugin_action_links_' . plugin_basename( __FILE__ ), 'twine_add_action_links' );
    function twine_add_action_links ( $links ) {
        $links[] = '<a target="_blank" href="'. get_admin_url(null, 'admin.php?page=twinesocial-key-setting') .'">Settings</a>';
        $links[] = '<a target="_blank" href="https://twinesocial.com/?utm_source=wordpress" target="_blank">Visit TwineSocial Website<a>';
        return $links;
    }
