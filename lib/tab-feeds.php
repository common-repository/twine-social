				...
				<div class="twine-widget-content">
					...
					<?php foreach ($campaign->feeds as $feed) { ?>
						<TR>
							...
							<TD><a target="_blank" class="btn btn-sm btn-default" href="https://<?php echo TWINE_CUSTOMER_URL?>/app/<?php echo $campaign->baseUrl?>/feeds/index">Edit Feed</a></TD>
						</TR>
					<?php } ?>
					<?php } ?>
					</tbody>
					...
					<HR>
					<p><i class="fa fa-info-circle"></i> <a href="https://customer.twinesocial.com">Upgrade now</a> to import new social media posts to your WordPress page faster.</p>

					<a class="btn btn-sm btn-primary" target="_blank" href="https://<?php echo TWINE_CUSTOMER_URL?>/app/<?php echo $campaign->baseUrl?>/feeds/index">Add Feed</a>
