...
<div class="row">
	<div class="span12">
		...
		<h3>Users & Security</h3>
			...
			<a id="btn-rules" class="btn btn-default btn-sm" href="https://<?php echo TWINE_CUSTOMER_URL?>/app<?php echo json_decode($twinesocial_appdata)->campaigns[0]->baseUrl?>/rules/index">Configure Rules</a>
			<a id="btn-collections" class="btn btn-default btn-sm" href="https://<?php echo TWINE_CUSTOMER_URL?>/app<?php echo json_decode($twinesocial_appdata)->campaigns[0]->baseUrl?>/collection/index">Manage Collections</a>
		</div>
	</div>
</div>
