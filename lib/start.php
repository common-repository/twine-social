...
<div class="row-fluid">
	<div class="span7">
		...
		<div class="form-group">
			...
			<?php if ($twinesocial_appdata) { ?>
				<a class="btn btn-default btn-sm" href="https://<?php echo TWINE_CUSTOMER_URL?>/">Manage My TwineSocial Account</a>
	...
	<div class="span5 <?php echo $twinesocial_appdata ? 'hide' : ''?>">
		...
		<p><span class="help-block"><i class="fa fa-exclamation-circle"></i> Find your TwineSocial Account # by <a target="_blank" href="<?php echo TWINE_CUSTOMER_URL?>/" target="_new">logging in</a>. Click on settings in the top right hand corner.</span></p>
	</div>
